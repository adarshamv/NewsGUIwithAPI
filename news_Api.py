...
import requests
from tkinter import *
from urllib.request import urlopen #for url to images
from PIL import ImageTk,Image #for display image

class NewsApp:
    def __init__(self):
        #fetch data
        self.data=requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=93b55ee51c164871b68d7f1f45420c99').json()
        #print(data)
    ...
    def load_news_item(self,index):
        ...
        try:
            ...
            img_url = 'https://www.shutterstock.com/image-vector/picture-vector-icon-no-image-260nw-1732584341.jpg'
            raw_data = urlopen(img_url).read()
            im = Image.open(io.BytesIO(raw_data)).resize((350, 250))
            photo = ImageTk.PhotoImage(im)
